...
export function updateCamera(){
  ...
  if(state.captureView){
    const p={front:[0,5.4,6.4,0,4.4,0],quarter:[4.6,5.6,4.6,0,4.4,0],hero:[0,5.0,5.35,0,4.9,1.48],overhead:[0,11.4,.02,0,6.2,0],closeup:[1.9,5,1.9,0,4.7,0],wide:[0,5,8.6,0,4.3,0]}[state.captureView];
    if(p){
