...
**Version:** v7.3 · **Phase 0 ✅ · Phase 1 ✅ · Phase 2 ✅ · Phase 3 ◐ (stylized procedural hero + complete specimen booth live)**
...
1. Walk (WASD / click scene for mouse-look). **HUD must show `16 fish` plus `hero clownfish · stylized procedural`** — if the troupe is absent, that's a spawn bug.
...
| 3 environment/materials | ◐ v7.3 — stylized procedural hero, transmissive water/glass, animated caustics, 13-entry photo booth + visual-smoke CI; production PBR assets remain |
